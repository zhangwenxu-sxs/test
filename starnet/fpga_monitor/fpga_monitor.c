...
static fpga_monitor_t* fpga_monitor = NULL;
static fpga_statistic_t* fpga_statistic = NULL;
static struct i2c_board_info i2c_info;
static struct work_struct fpga_interrupt_tasklet;

static char proc_msg_buf[FPGA_PROC_MSG_BUFF_SIZE];  //用于存放转换成字符串后的fpga_statistic信息
...
static int fpga_fops_open(struct inode* inode, struct file* file)
{
    memset(proc_msg_buf, 0, sizeof(proc_msg_buf));
